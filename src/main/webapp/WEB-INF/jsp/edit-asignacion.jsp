...
<meta charset="UTF-8"/><title>Editar Asignación</title>
...
<div class="container">
  ...
  <form action="${pageContext.request.contextPath}/asignaciones" method="post" class="form">
    <input type="hidden" name="idCotizacion" value="${asignacion.idCotizacion}"/>
    ...
    <div class="form-actions">
      ...
      <button type="button" class="button cancel"
              onclick="location.href='${pageContext.request.contextPath}/asignaciones?action=list&idCotizacion=${asignacion.idCotizacion}'">
        Cancelar
      </button>
    </div>
  </form>
